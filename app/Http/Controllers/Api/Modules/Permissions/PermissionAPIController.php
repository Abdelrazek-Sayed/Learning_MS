...
class PermissionAPIController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->ApiResponse(205, 'No permissions Found');
    }
}
